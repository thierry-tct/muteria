...
class ConvertCollectKtestsSeeds:
    ...
    def generate_seeds_from_various_ktests (self, dest_dir, \
        ...
        """
        Create seeds/unify ktest from shadow and klee/Semu
        :param dest_dir: Non existing directory name where to put the 
                          generated seeds. Its parent dir must exist
        :param src_old_shadow_zesti_ktest_dir: path to directory or tar.gz 
                          containing the shadow generated tests 
                          (to convert into SEMu recognized ktest)
        :param src_new_klee_ktest_dir_or_sym_args: This provide elements
                          that can increase the space of the symbolic args
                          besides what is extracted from shadow tests.
                          Specify either the list of sym args for the program
                          (e.g. `["--sym-arg 5", "-sym-args 0 2 3"]`). This
                          requires `klee_ktest_is_sym_args` to be True. 
                          Or set it to a folder containig tests generated by
                          KLEE or SEMu (newer ktests format). This require
                          `klee_ktest_is_sym_args` to be False.
        :param klee_ktest_is_sym_args: Tels whether a sym args list or folder
                          is specified in `src_new_klee_ktest_dir_or_sym_args`
        :param compress_dest: Tesl whether to compress the `dest_dir` after
                          generation of seeds.
        :param skip_failure: Tells whether to skip problematic Ktests.
        """
