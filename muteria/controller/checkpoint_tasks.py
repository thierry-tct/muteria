...
class TaskOrderingDependency(object): 
    ...
    def __init__(self, done_starting=False,
        ...
        finishing.set_is_done(done_finishing)
    ...
    def set_task_back_as_todo(self, task_name):
        t = self._lookup_task_cell(task_name)
        self._recursive_set_task_back_as_todo(t)
