...
def build_func_shadow(*args, **kwargs):
    ...
    klee_change_macro_file = shadow_se_module.__file__
    flags += ['-DENABLE_SHADOW_SE', '-I'+klee_change_macro_file] 
    args = args[:3] + flags+ args[4:]
...
# klee tests
shadow_se_test = TestcaseToolsConfig(tooltype=TestToolType.USE_ONLY_CODE, toolname='shadow_se', \
